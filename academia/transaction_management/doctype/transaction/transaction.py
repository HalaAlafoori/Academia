...
# get User of employee in a company an have a designation
# @frappe.whitelist()
# def get_user_from_designation(company, designation):
#     # Get the employee with the given designation
...
#     if employee:
#         # Return the user associated with the employee
#         return employee[0].user_id
#     else:
#         return None
